    ...
    >
      <div ref={contentRef} className="flex flex-col items-center z-10">
        ...
        <div className="text-3xl md:text-4xl sm:px-3 text-black dark:text-white font-[1000] text-center mt-7">
          ...
          <p className="text-secondary font-normal text-sm md:text-lg mt-7">
            We transform complex challenges into <br /> seamless Web, AI, and
            IoT integrations.
          </p>
        </div>
        <button
      ...
      <div
        ref={linesRef}
        className="absolute inset-0 w-full h-full -z-10 opacity-50 dark:opacity-30 hidden md:dark:block"
      >
        <FloatingLines
